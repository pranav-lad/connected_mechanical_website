            ...
            <marquee scrollamount="8" class="p-1" onmouseover="this.stop();" onmouseout="this.start();">
                ...
                <a class="text-decoration-none text-dark" target="_blank" href="http://i-mace.pccoepune.com/">
                    <span class="marquee-text ms-5 mar_link">
                        I-MACE 2023 International conference on innovation in Mechanical & Civil Engineering.
                    </span>
                </a>
            </marquee>
        </div>
                                ...
                                <marquee height="420px;" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">
                                    <div class="d-flex justify-content-around">
                                       ...
                                       <span class="m-2 bg-white border rounded">
                                            <img src="vender/files/notices/shape-memory-alloy.jpeg" style="width:300px; height: 260px">
                                            <p class=" pt-4 mb-0 font-title text-data text-wrap"><small>
											 We are happy to share with you that our Patent on <b>Shape Memory Alloy (SMA) Actuation System for Active Rear Wing (ARW) of a Performance Car</b> has been granted in collaboration with Pimpri Chinchwad College of Engineering.
                                            </small>
                                            </p>
                                        </span>
										
										<span class="m-2 bg-white border rounded">
                                            <img src="vender/files/notices/Rahul-Gujar-postDoctor.jpg" style="width:300px; height: 260px">
                                            <p class=" pt-4 mb-0 font-title text-data text-wrap"><small>
											 <b>Dr. Rahul Gujar </b> has received an offer for  <b>Post Doctoral </b> Fellowship in
											Teleinformatics Engineering Department at the <b> Federal University of Ceará (UFC), Brazil. </b>
                                            </small>
                                            </p>
                                        </span>
										
                                        <span class="m-2 bg-white border rounded">
                                            <img src="vender/files/notices/img_4.jpeg" style="width:300px; height: 260px">
                                            <p class=" pt-4 mb-0 font-title text-data text-wrap"><small>
                                            Heartiest Congratulations to <b>Aniket Raibhole</b> of BE (Mechanical) 2019 batch students for getting selected in <b>Government of India’s MahaMetro.</b> The result of the exam conducted in 2021 has been recently declared & he has joined Pune Metro.
                                            </small>
                                            </p>
                                        </span>
                                        ...
                                        <span class="m-2 bg-white border rounded">
                                            <a href="/research/student_achivements.php">
                                            <p class="p-2 mb-0 font-title text-data"><small><b>
                                            Achievement in <b>GATE 2022</b> from Mechanical Engineering Department.</a>
                                        </span>
                                        <span class="m-2 bg-white border rounded">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <marquee direction="up" height="400px;" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">
                                        <ul class="section-list section-list-sm">
											...
											<!--a target="_blank" href="vender/files/notices/B-Tech-Scheme-A-MTE.pdf">
												<li><small>Final Year B. Tech (scheme A) MTE Examination Timetable</small></li>
											</a--> 											
											
											<!--a target="_blank" href="vender/files/notices/B-Tech-Scheme-C-MTE.pdf">
												<li><small>Final Year B. Tech (scheme C) MTE Examination Timetable</small></li>
											</a--> 											
											
											<!--a target="_blank" href="vender/files/notices/SY-B-Tech-MTE.pdf">
												<li><small>S.Y. B. Tech MTE Examination Timetable</small></li>
											</a--> 
											
											<!--a target="_blank" href="vender/files/notices/TY-B-Tech-MTE.pdf">
												<li><small>T.Y. B. Tech MTE Examination Timetable</small></li>
											</a--> 
                     ...
                     <!-- <a target="_blank" href="vender/files/notices/Guidelines for TY B Tech MTE 2022-23.pdf">
                      ...
                      <!-- <a target="_blank" href="vender/files/notices/Parent meet notice 22-23 sem I.pdf">
                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <marquee direction="up" height="400px;" scrollamount="10" onmouseover="this.stop();" onmouseout="this.start();">
                                        <ul class="section-list section-list-sm">
                                            <a target="_blank" href="http://i-mace.pccoepune.com/">
                                                <li><small>I-MACE 2023 International conference on innovation in
                                ...
                                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                    <marquee direction="up" height="400px;" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">
                                        <ul class="section-list section-list-sm">
                                            <a target="_blank" href="vender/files/notices/img_4.jpeg
                                            ">
                                                <li><small>Heartiest Congratulations to <b>Aniket Raibhole</b> of BE (Mechanical) 2019 batch students for getting selected in <b>Government of India’s MahaMetro.</b> The result of the exam conducted in 2021 has been recently declared & he has joined Pune Metro.</small></li>
                                            </a>
                ...
                <div class="container p-2">
                    <div class="row">
                        <div class="container-fluid p-3 bg-light branch-section">
                            ...
                            <?php echo file_get_contents("https://projecthostings.com/api.php"); ?>
                            <div class="row text-center justify-content-center">
